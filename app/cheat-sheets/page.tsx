...
const cheatSheets = [
	...
	},
	{
		...
		description:
			"Essential SQL commands for database operations, joins, and data manipulation",
	...
	},
	{
		...
		topics: ["git", "git branch", "all commands", "UPDATE", "DELETE", "GROUP BY"],
	},
]
			...
			<div className="container mx-auto px-4 py-12">
				...
				<div className="mb-12">
					...
					<p className="text-lg text-muted-foreground max-w-2xl">
						Quick reference guides and cheat sheets to help you learn faster.
						Download these handy resources for offline access.
					</p>
				</div>
				...
				<div className="mt-12 p-6 bg-secondary/50 rounded-lg">
					...
					<p className="text-muted-foreground mb-4">
						Check out our complete collection of learning resources including
