...
import { Home, BookOpen, User, FileText, Settings, Menu, X, GraduationCap, FolderOpen } from "lucide-react"
...
const navigation = [
  ...
  { name: "Cheat Sheets", href: "/portal/cheat-sheets", icon: FileText },
  { name: "Software", href: "/portal/softwares", icon: Settings },
]
